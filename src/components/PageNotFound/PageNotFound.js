...
const PageNotFound = () => {
  ...
  return (
    <div className="page-not-found">
      ...
      <svg
        className="page-not-found_svg second"
        width="1920"
        height="428"
